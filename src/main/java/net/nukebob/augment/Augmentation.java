...
public class Augmentation implements ClientModInitializer {
	...
	private static final KeyBinding.Category AUGMENTATION_CATEGORY = KeyBinding.Category.create(Identifier.of(MOD_ID, "augmentation"));
	...
	public void onInitializeClient() {
		...
		ClientTickEvents.END_CLIENT_TICK.register(client -> {
			if (InputUtil.isKeyPressed(MinecraftClient.getInstance().getWindow(), KeyBindingHelper.getBoundKeyOf(Augmentation.keyBindingAll).getCode())) {
